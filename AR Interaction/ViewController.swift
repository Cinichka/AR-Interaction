...
//  AR Interaction
//
//  Created by Denis Bystruev on 17/09/2018.
...
class ViewController: UIViewController, ARSCNViewDelegate {
	...
	func createBasketball() {
		...
		ball.geometry?.firstMaterial?.diffuse.contents = #colorLiteral(red: 0.9411764741, green: 0.4980392158, blue: 0.3529411852, alpha: 1)
	...
	func renderer(_ renderer: SCNSceneRenderer, updateAtTime time: TimeInterval) {
		balls.filter{ $0.presentation.position.y < -2 }.forEach{ $0.removeFromParentNode()}
	}
